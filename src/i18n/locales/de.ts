...
const de: Record<string, string> = {
    ...
    "playQuiz.report.button": "Melden",
    "playQuiz.report.buttonTitle": "Problem mit dieser Frage melden",
    "playQuiz.report.title": "Problem melden",
    "playQuiz.report.questionNumber": "Frage {number} von {total}",
    "playQuiz.report.reasonLabel": "Was ist das Problem?",
    "playQuiz.report.reasons.factual": "Inhaltlicher Fehler / Falsche Antwort",
    "playQuiz.report.reasons.typo": "Tippfehler oder Übersetzungsfehler",
    "playQuiz.report.reasons.brokenMedia": "Fehlendes Bild oder fehlerhafte Karte",
    "playQuiz.report.reasons.inappropriate": "Unangemessener Inhalt",
    "playQuiz.report.reasons.other": "Anderes Problem",
    "playQuiz.report.detailsLabel": "Details (optional)",
    "playQuiz.report.detailsPlaceholder": "Erkläre kurz das Problem für die Moderatoren...",
    "playQuiz.report.submit": "Meldung senden",
    "playQuiz.report.cancel": "Abbrechen",
    "playQuiz.report.sending": "Wird gesendet...",
    "playQuiz.report.success": "Meldung erfolgreich gesendet. Vielen Dank!",
    "playQuiz.report.loginRequired": "Du musst angemeldet sein, um eine Frage zu melden.",
    "playQuiz.keyboard.enter": "Eingabe ↵",
    "playQuiz.keyboard.space": "Leertaste ␣",
    "profile.back": "Zurück",
...
helpdesk@terracoast.ch`,
    ...
    // Live Party Mode
    "nav.party": "Party",
    "party.title": "Live-Partysalon 🏆",
    "party.buttonTitle": "Salon- / Party-Modus 🏆",
    "party.quickDesc": "Kahoot-Stil • 4 bis 10 Freunde mit PIN",
    "party.joinRoom": "Salon beitreten",
    "party.createRoom": "Salon erstellen",
    "party.roomCode": "Salon-Code",
    "party.yourPseudo": "Dein Nickname",
    "party.hostPseudo": "Dein Host-Nickname",
    "party.chooseAvatar": "Avatar wählen",
    "party.joinButton": "Partie beitreten 🚀",
    "party.createButton": "Salon erstellen & Freunde einladen 👑",
    "party.timeLimit": "Zeit pro Frage",
    "party.selectQuiz": "Quiz auswählen",
    "party.scanWithPhone": "Mit Smartphone scannen 📱",
    "party.copyLink": "Einladungslink kopieren",
    "party.linkCopied": "Link kopiert!",
    "party.connectedPlayers": "Verbundene Spieler",
    "party.startGame": "Partie starten",
    "party.nextQuestion": "Nächste Frage",
    "party.viewPodium": "Podium ansehen 🏆",
    "party.waitingForHost": "Warten auf den Host... Mach dich bereit!",
    "party.answerSent": "Antwort gesendet!",
    "party.correctAnswer": "Richtige Antwort! 🎉",
    "party.wrongAnswer": "Falsche Antwort... 😢",
    "party.answersBreakdown": "Antwortenverteilung der Spieler",
    "party.provisionalLeaderboard": "Zwischenstand",
    "party.finalPodium": "Finales Podium",
    "party.championsCongrats": "Glückwunsch an die Champions! 🏆",
    "party.playAgain": "Erneut in diesem Salon spielen",
    "party.leave": "Salon verlassen",
    "party.backToHome": "Zurück zur Startseite",

    // Flamme quotidienne / Daily Streaks
    "streak.daysStreak": "Tage Flammen-Serie",
    "streak.dayStreak": "Tag Flammen-Serie",
    "streak.validatedToday": "Serie für heute gesichert!",
    "streak.dangerPrompt": "Serie in Gefahr! Spiele vor Mitternacht",
    "streak.startPrompt": "Spiele heute, um deine Flamme zu entzünden!",
    "streak.weekProgress": "Diese Woche",
    "streak.totalFire": "Flammen-XP-Bonus",
    "streak.playMore": "Weiter üben",
    "streak.playNow": "Jetzt spielen und Flamme sichern 🔥",
    "streak.validated": "Heute abgeschlossen",
    "streak.inDanger": "In Gefahr!",

    // Quiz du Jour / Daily Challenge
    "daily.title": "Quiz des Tages",
    "daily.badge": "Tages-Herausforderung",
    "daily.todayRanking": "Tages-Rangliste",
    "daily.noEntriesTitle": "Sei der Erste auf dem Podium!",
    "daily.noEntriesDesc": "Heute hat noch niemand Punkte bei diesem Quiz erzielt. Spiele jetzt und übernimm die Führung!",
    "daily.allParticipants": "Alle Teilnehmer des Tages",
    "daily.streakBonus": "+ Flammen-Bonus 🔥",
    "daily.completedToday": "Herausforderung gemeistert!",
    "daily.challengeCommunityPrompt": "Die gesamte Community tritt heute an!",
    "daily.viewLeaderboard": "Rangliste",
    "daily.replayChallenge": "Wiederholen",
    "daily.playChallenge": "Herausforderung annehmen",
    "daily.challengeCompletedTitle": "Tages-Herausforderung abgeschlossen!",
    "daily.challengeCompletedDesc": "Dein Ergebnis wurde in der Tagesrangliste gespeichert und deine Serie läuft weiter!",

    // Atlas & Freie Erkundung
    "nav.atlas": "Atlas",
    "home.exploreAtlasDesc": "Erkunde die Welt, Hauptstädte, Flaggen und Länder-Daten",
    "atlas.badge": "Freier Erkundungsmodus",
    "atlas.title": "Interaktiver Weltatlas 🗺️",
    "atlas.subtitle": "Klicke auf ein beliebiges Land auf der 2D-Karte oder dem 3D-Globus, um Hauptstädte, Flaggen und Daten zu lernen.",
    "atlas.viewMap": "2D-Karte",
    "atlas.viewGlobe": "3D-Globus",
    "atlas.viewList": "Karten",
    "atlas.searchPlaceholder": "Land, Hauptstadt, Code suchen...",
    "atlas.mapHint": "Klicke auf ein Land, um die Detailansicht zu öffnen.",
    "atlas.globeHint": "Ziehen zum Drehen des Globus. Klicke auf Markierungen zur Erkundung.",
    "atlas.capital": "Hauptstadt",
    "atlas.region": "Kontinent",
    "atlas.population": "Bevölkerung",
    "atlas.area": "Fläche",
    "atlas.currency": "Währung(en)",
    "atlas.languages": "Amtssprache(n)",
    "atlas.coordinates": "Koordinaten & Subregion",
    "atlas.borders": "Nachbarländer",
    "atlas.playQuizOnCountry": "Mein Wissen über dieses Land testen",
    "atlas.noResultsTitle": "Kein Land gefunden",
  };
