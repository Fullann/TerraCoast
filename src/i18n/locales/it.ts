...
const it: Record<string, string> = {
    ...
    "playQuiz.report.button": "Segnala",
    "playQuiz.report.buttonTitle": "Segnala un problema su questa domanda",
    "playQuiz.report.title": "Segnala un problema",
    "playQuiz.report.questionNumber": "Domanda {number} di {total}",
    "playQuiz.report.reasonLabel": "Qual è il problema?",
    "playQuiz.report.reasons.factual": "Errore sui fatti / Risposta errata",
    "playQuiz.report.reasons.typo": "Errore ortografico o di traduzione",
    "playQuiz.report.reasons.brokenMedia": "Immagine mancante o mappa non funzionante",
    "playQuiz.report.reasons.inappropriate": "Contenuto inappropriato od offensivo",
    "playQuiz.report.reasons.other": "Altro problema",
    "playQuiz.report.detailsLabel": "Dettagli aggiuntivi (opzionale)",
    "playQuiz.report.detailsPlaceholder": "Spiega brevemente il problema per aiutare i moderatori...",
    "playQuiz.report.submit": "Invia segnalazione",
    "playQuiz.report.cancel": "Annulla",
    "playQuiz.report.sending": "Invio in corso...",
    "playQuiz.report.success": "Segnalazione inviata ai moderatori. Grazie per il tuo aiuto!",
    "playQuiz.report.loginRequired": "Devi aver effettuato l'accesso per segnalare una domanda.",
    "playQuiz.keyboard.enter": "Invio ↵",
    "playQuiz.keyboard.space": "Spazio ␣",
...
helpdesk@terracoast.ch`,
    ...
    // Live Party Mode
    "nav.party": "Party",
    "party.title": "Stanza Party dal vivo 🏆",
    "party.buttonTitle": "Modalità Stanza / Party 🏆",
    "party.quickDesc": "Stile Kahoot • 4-10 amici con PIN",
    "party.joinRoom": "Entra in una stanza",
    "party.createRoom": "Crea una stanza",
    "party.roomCode": "Codice Stanza",
    "party.yourPseudo": "Tuo Nickname",
    "party.hostPseudo": "Tuo Nickname da Host",
    "party.chooseAvatar": "Scegli un avatar",
    "party.joinButton": "Entra nella partita 🚀",
    "party.createButton": "Genera Stanza e Invita Amici 👑",
    "party.timeLimit": "Tempo per domanda",
    "party.selectQuiz": "Seleziona un Quiz",
    "party.scanWithPhone": "Scansiona con smartphone 📱",
    "party.copyLink": "Copia link di invito",
    "party.linkCopied": "Link copiato!",
    "party.connectedPlayers": "Giocatori connessi",
    "party.startGame": "Avvia partita",
    "party.nextQuestion": "Domanda successiva",
    "party.viewPodium": "Vedi podio 🏆",
    "party.waitingForHost": "In attesa che l'host avvii... Preparati!",
    "party.answerSent": "Risposta inviata!",
    "party.correctAnswer": "Risposta corretta! 🎉",
    "party.wrongAnswer": "Risposta errata... 😢",
    "party.answersBreakdown": "Distribuzione risposte dei giocatori",
    "party.provisionalLeaderboard": "Classifica provvisoria",
    "party.finalPodium": "Podio Finale",
    "party.championsCongrats": "Congratulazioni ai campioni! 🏆",
    "party.playAgain": "Gioca di nuovo in questa stanza",
    "party.leave": "Esci dalla stanza",
    "party.backToHome": "Torna alla home",

    // Flamme quotidienne / Daily Streaks
    "streak.daysStreak": "Giorni serie di fuoco",
    "streak.dayStreak": "Giorno serie di fuoco",
    "streak.validatedToday": "Serie assicurata per oggi!",
    "streak.dangerPrompt": "Serie a rischio! Gioca prima di mezzanotte",
    "streak.startPrompt": "Gioca oggi per accendere la tua fiamma!",
    "streak.weekProgress": "Questa settimana",
    "streak.totalFire": "Bonus XP Fiamma",
    "streak.playMore": "Continua ad allenarti",
    "streak.playNow": "Gioca ora per convalidare la fiamma 🔥",
    "streak.validated": "Convalidata oggi",
    "streak.inDanger": "In pericolo!",

    // Quiz du Jour / Daily Challenge
    "daily.title": "Quiz del Giorno",
    "daily.badge": "Sfida Giornaliera",
    "daily.todayRanking": "Classifica del Giorno",
    "daily.noEntriesTitle": "Sii il primo sul podio!",
    "daily.noEntriesDesc": "Nessuno ha ancora registrato un punteggio oggi su questo quiz. Gioca ora per prendere la testa!",
    "daily.allParticipants": "Tutti i partecipanti del giorno",
    "daily.streakBonus": "+ Bonus Fiamma 🔥",
    "daily.completedToday": "Sfida Superata!",
    "daily.challengeCommunityPrompt": "Tutta la community si sfida oggi!",
    "daily.viewLeaderboard": "Classifica",
    "daily.replayChallenge": "Rigioca",
    "daily.playChallenge": "Accetta la Sfida",
    "daily.challengeCompletedTitle": "Sfida Giornaliera Completata!",
    "daily.challengeCompletedDesc": "Il tuo punteggio è registrato nella classifica di oggi e la tua fiamma continua a brillare!",

    // Atlas & Esplorazione libera
    "nav.atlas": "Atlante",
    "home.exploreAtlasDesc": "Esplora il mondo, capitali, bandiere e schede dei paesi",
    "atlas.badge": "Modalità Esplorazione Libera",
    "atlas.title": "Atlante Mondiale Interattivo 🗺️",
    "atlas.subtitle": "Clicca su qualsiasi paese sulla mappa 2D o sul globo 3D per ripassare capitali, bandiere e dati chiave.",
    "atlas.viewMap": "Mappa 2D",
    "atlas.viewGlobe": "Globo 3D",
    "atlas.viewList": "Schede",
    "atlas.searchPlaceholder": "Cerca paese, capitale, codice...",
    "atlas.mapHint": "Clicca su un paese per aprire i dettagli e ripassare.",
    "atlas.globeHint": "Trascina per ruotare il globo. Clicca su un indicatore per esplorare.",
    "atlas.capital": "Capitale",
    "atlas.region": "Continente",
    "atlas.population": "Popolazione",
    "atlas.area": "Superficie",
    "atlas.currency": "Valuta/e",
    "atlas.languages": "Lingua/e ufficiale/i",
    "atlas.coordinates": "Coordinate e Subregione",
    "atlas.borders": "Paesi Confinanti",
    "atlas.playQuizOnCountry": "Metti alla prova le tue conoscenze su questo paese",
    "atlas.noResultsTitle": "Nessun paese trovato",
  };
