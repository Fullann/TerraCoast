...
helpdesk@terracoast.ch`,
    ...
    // Hors Ligne & Accessibilité
    "offline.title": "Mode Hors Ligne",
    "offline.banner": "Vous êtes hors ligne. Les fonctionnalités multijoueur et la synchronisation des scores sont suspendues.",
    "offline.reconnected": "Connexion Internet rétablie !",
    "offline.savePending": "Vos résultats sont enregistrés localement et seront synchronisés dès le retour de la connexion.",
    "offline.retrySave": "Réessayer la synchronisation",
