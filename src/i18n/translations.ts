...
export const translations: Record<Language, Record<string, string>> = {
  fr: {
    ...
    "home.trainingSpotlightTitle": "Nouveau: Entraînement guidé",
    "home.trainingSpotlightDesc":
      "Choisis un quiz, ajuste le nombre de questions et entraîne-toi sans pression.",
    "home.trainingSpotlightCta": "Essayer",
    ...
    "quizzes.map.title": "Carte 2D des quiz géolocalisés",
    "quizzes.map.subtitle": "Clique sur un continent pour zoomer et voir les quiz associés.",
    "quizzes.map.resetView": "Réinitialiser la vue",
    "quizzes.map.approxPosition": "Position approx.",
    "quizzes.map.hiddenCount":
      "{count} quiz non affichés (aucune localisation trouvée)",
    "quizzes.map.continent.all": "Monde",
    "quizzes.map.continent.europe": "Europe",
    "quizzes.map.continent.africa": "Afrique",
    "quizzes.map.continent.asia": "Asie",
    "quizzes.map.continent.americas": "Amériques",
    "quizzes.map.continent.oceania": "Océanie",
    "quizzes.average": "Moy",
    ...
    "quizzes.trainingBannerTitle": "Entraînement plus simple",
    "quizzes.trainingBannerDesc":
      "Passe en mode entraînement pour apprendre sans limite de temps.",
    "quizzes.trainNow": "S'entraîner sur ce quiz",
    ...
    "admin.duelFeatures.title": "Fonctions des duels classés",
    "admin.duelFeatures.subtitle":
      "Active ou désactive les protections et options du matchmaking classé.",
    "admin.duelFeatures.enabled": "Activé",
    "admin.duelFeatures.disabled": "Désactivé",
    "admin.duelFeatures.accessDenied": "Accès refusé",
    "admin.duelFeatures.anti_repeat.label": "Anti-rematch immédiat",
    "admin.duelFeatures.anti_repeat.description":
      "Empêche de retomber contre le même joueur pendant une courte période.",
    "admin.duelFeatures.progressive_expand.label":
      "Élargissement progressif des critères",
    "admin.duelFeatures.progressive_expand.description":
      "Relâche les préférences si la recherche dure trop longtemps.",
    "admin.duelFeatures.show_opponent_mmr.label":
      "Afficher le MMR adverse avant lancement",
    "admin.duelFeatures.show_opponent_mmr.description":
      "Ajoute un écran de confirmation avec le MMR de l'adversaire.",
    "admin.nav.dashboard": "Dashboard",
    "admin.nav.overview": "Vue admin",
    "admin.nav.analytics": "Analytics",
    "admin.nav.quizOps": "Quiz",
    "admin.nav.quizManagement": "Gestion des quiz",
    "admin.nav.quizValidation": "Validation des quiz",
    "admin.nav.geojsonMaps": "Cartes GeoJSON",
    "admin.nav.moderation": "Modération",
    "admin.nav.reports": "Signalements",
    "admin.nav.userManagement": "Utilisateurs",
    "admin.nav.settings": "Configuration",
    "admin.nav.duelFeatures": "Fonctions duel",
    "admin.nav.badges": "Badges",
    "admin.nav.titles": "Titres",
    "admin.nav.categories": "Catégories",
    "admin.nav.difficulties": "Difficultés",
    "admin.nav.quizTypes": "Types de quiz",
    "admin.dashboard.subtitle": "Pilotage global de la plateforme TerraCoast",
    "admin.dashboard.totalUsers": "Utilisateurs",
    "admin.dashboard.totalQuizzes": "Quiz",
    "admin.dashboard.pendingValidation": "Quiz à valider",
    "admin.dashboard.pendingReports": "Signalements en attente",
    "admin.dashboard.missingLocation": "Quiz sans localisation",
    ...
    "training.clearSearch": "Effacer la recherche",
    "training.searchHint": "Recherche par titre, description, catégorie ou tag",
    "training.filterAll": "Tous",
    "training.filterPopular": "Populaires",
    "training.filterShort": "Rapides",
    "training.resultsCount": "résultats",
    "training.games": "parties",
    "training.questions": "questions",
    "training.max": "max",
    "training.start": "Commencer l'entraînement",
    "training.quickStartTitle": "Démarrage rapide",
    "training.quickStartHint":
      "Pas sûr de quoi choisir ? Commence avec le quiz le plus joué.",
    "training.pickPopularQuiz": "Choisir le quiz populaire",
    "training.noQuizResult": "Aucun quiz ne correspond à ta recherche.",
    "training.estimatedDuration": "Durée estimée",
    "training.selectQuizFirst": "Choisis un quiz pour démarrer",
    ...
    "profile.mmr": "MMR",
    "profile.rankedDuels": "duels classés",
    ...
    "profile.frame": "Cadre",
    "profile.frameNone": "Aucun",
    "profile.frameEmerald": "Émeraude",
    "profile.frameGold": "Or",
    "profile.frameRainbow": "Arc-en-ciel",
    "profile.frameIce": "Glace",
    "profile.frameShadow": "Ombre",
    ...
    "duels.startRankedSearch": "Recherche aléatoire classée",
    "duels.startCasualSearch": "Recherche aléatoire non classée",
    "duels.searchingOpponent": "Recherche d'un adversaire...",
    "duels.cancelSearch": "Annuler la recherche",
    "duels.inQueueSince": "En file depuis",
    "duels.noQueue": "Aucune recherche active",
    "duels.matchTypeRanked": "Mode classé",
    "duels.matchTypeCasual": "Mode non classé",
    "duels.rankedTag": "Classé",
    "duels.casualTag": "Amical",
    "duels.anyDifficulty": "Toute difficulté",
    "duels.anyQuiz": "Tous les quiz",
    "duels.preferredDifficultyLabel": "Difficulté préférée:",
    "duels.preferredQuizLabel": "Quiz préféré:",
    "duels.preferredQuizUnknown": "Quiz sélectionné",
    "duels.rankedOnlyHistory": "Classé uniquement",
    "duels.matchFound": "Match trouvé !",
    "duels.opponentLabel": "Adversaire:",
    "duels.opponentMmrLabel": "MMR adverse:",
    "duels.startDuelNow": "Lancer le duel",
    "duels.unknownOpponent": "Adversaire inconnu",
    "duels.queueModeTargeted": "Quiz ciblés (liste)",
    "duels.queueModeRandomBonus": "Aléatoire total (bonus)",
    "duels.quizSelectionCount": "Quiz sélectionnés:",
    "duels.preferredQuizListLabel": "Nombre de quiz ciblés:",
    ...
    "challenge.title": "Défi entre amis",
    "challenge.subtitle": "Bats mon score ({score}) sur : {title}",
    "challenge.send": "Envoyer le défi",
    "challenge.success": "Défi envoyé",
    "challenge.successMessage": "Ton défi a été envoyé à tes amis.",
    "challenge.error": "Impossible d'envoyer le défi. Réessaie.",
    "share.error": "Impossible de partager ce quiz pour le moment.",
    ...
    "settings.profilePhotoHint": "Choisis une image (PNG, JPG ou WEBP). Elle sera visible partout dans l’app.",
    "settings.profilePhotoUpdated": "Photo de profil mise à jour.",
    "settings.profilePhotoError": "Impossible de mettre à jour la photo de profil.",
    "settings.visualEffects": "Effets visuels",
    "settings.visualEffectsHint": "Choisis un cadre autour de ton avatar. Il sera visible dans le classement et sur ton profil.",
    "settings.visualEffectsUpdated": "Effets visuels mis à jour.",
    "settings.visualEffectsError": "Impossible de mettre à jour les effets visuels.",
    ...
    "leaderboard.modeDuelRanked": "Duels classés",
    "leaderboard.duelRating": "Elo duel",
    "leaderboard.rankedGames": "duels classés",
    // Landing Page
